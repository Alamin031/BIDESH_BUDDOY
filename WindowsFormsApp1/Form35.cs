...
namespace WindowsFormsApp1
{
    public partial class Form35 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into EUROPE_UNIVERSITY_INFORMATION_PORTAL values (@University_Name,@University_Rank,@University_Address,@Department,@Course,@Course_Fees,@Course_Credit,@CGPA_Discount,@IELTS_Discount,@Photo)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "update EUROPE_UNIVERSITY_INFORMATION_PORTAL set University_Name=@University_Name,University_Rank=@University_Rank,University_Address=@University_Address,Department=@Department,Course=@Course,Course_Fees=@Course_Fees,Course_Credit=@Course_Credit,CGPA_Discount=@CGPA_Discount,IELTS_Discount=@IELTS_Discount,Photo=@Photo where University_Rank=@University_Rank";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@University_Name", textBox1.Text);
            cmd.Parameters.AddWithValue("@University_Rank", textBox2.Text);
            cmd.Parameters.AddWithValue("@University_Address", textBox3.Text);
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from EUROPE_UNIVERSITY_INFORMATION_PORTAL where University_Rank=@University_Rank";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@University_Rank", textBox2.Text);
